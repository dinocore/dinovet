Feature: Manage employees
  ...
  Scenario: Add a new employee
    ...
    And I select "Home" from "employee_phone_numbers_0_type" within "#phone-number-0"
    And I fill in "employee_phone_numbers_0_number" with "1" within "#phone-number-0"
  ...
  Scenario Outline: Invalid employee data entered
    ...
    And I fill in "employee_phone_numbers_0_number" with "<phone_number>" within "#phone-number-0"
